...
import EditDialog from './subsys-role-edit-dialog.vue'
...
hooksOptions.getListURL = '/sub/system/role/page'
hooksOptions.needPage = true
hooksOptions.deleteURL = '/sub/system/role'
